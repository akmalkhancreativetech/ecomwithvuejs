        ...
        <div class="row">
            <div class="col-md-8 offset-md-2">
                <div class="order-box">
                    ...
                    <p class="text-small text-muted float-left">$ {{product.price}}</p>
                    <p class="text-small text-muted float-right">Available Units: {{product.units}}</p><br>
                    <hr>
                    <label class="row">
...
<script>
    export default {
        props: ['pid'],
        data(){
            return { address: "", quantity: 1, isLoggedIn: null, product: [] }
        },
        mounted() {
